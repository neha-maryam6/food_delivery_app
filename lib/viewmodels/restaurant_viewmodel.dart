...
class RestaurantViewModel {
  ...
  // 2. Sirf Is Particular Restaurant Ke Food Items Stream Se Read Karna (Price-wise Sorted)
  Stream<List<FoodItemModel>> getRestaurantMenu() {
    ...
    return _firestore
        ...
        .snapshots()
        .map((snapshot) {
      List<FoodItemModel> menuItems = snapshot.docs
          .map((doc) => FoodItemModel.fromMap(doc.data()))
          .toList();

      // Dart mein price-wise sort karna (Lowest price first)
